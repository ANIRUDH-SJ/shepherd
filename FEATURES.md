...
| 10 | **Semantic agent runtime + integrations** | validated provider-neutral lifecycle state, workspace rollups, elapsed/freshness policy, exact focus/wait controls, provider hooks, and a managed plugin | 🟢 |
