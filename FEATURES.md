...
| 14  | **Semantic dark theme**                                              | neutral near-black CSS roles, measured contrast, semantic-only color/motion, restrained geometry, and an independent frozen xterm palette; optionally map validated Ghostty colors (#20) | 🟢                                                          |
