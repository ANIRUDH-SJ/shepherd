...
export default function Sidebar({ workspaces, activeWorkspaceId, dispatch, onCollapse }: Props): React.JSX.Element {
  return (
    <div className="sidebar-inner">
      <div className="sidebar-head">
        <span className="brand">cmux-linux</span>
        <div className="sidebar-head-actions">
          <button className="icon-btn" title="New workspace (Ctrl+Shift+N)" onClick={() => dispatch(createWorkspaceAction())}>
            +
          </button>
